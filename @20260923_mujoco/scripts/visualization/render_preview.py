...
用法：
    pixi run python scripts/render_preview.py [--camera front|side|iso] [--out output/python/rest_preview_<camera>.png]
"""
...
def main() -> int:
    ...
    parser.add_argument("--out", type=pathlib.Path, default=None,
                        help="默认 output/python/rest_preview_<camera>.png")
    parser.add_argument("--width", type=int, default=1280)
    parser.add_argument("--height", type=int, default=720)
    args = parser.parse_args()
    out = args.out or (ROOT / f"output/python/rest_preview_{args.camera}.png")
